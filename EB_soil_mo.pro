Function EB_soil_mo, epsilon, alpha, cg, zr, z0m, rss, ta, ua, rg, rha, SIGMA
...
;  ===================================================================================*/
  ...
  NITER_T = 200; // number of iterations considered for running the loop on Ts minimization
  NITER_H = 200
  NITER_rah = 200
...
;;;// Loop on U
  ...
  Function longwave, ea, ta, SIGMA
    ...
    epsa = 0.553*(ea/100)^0.143; 1.24*(ea/(100*ta))^0.143 ;-->ea:[Pa] ta:[K];  --> ea:[Pa]
