...
for aa=0,n_elements(alpha)-1 do begin
  Tvmin_eb[*,aa] = EB_veg_mo( epsilon, alpha[aa], cg, zr, h, rc_min, ta, ua, rg, rha, SIGMA)
  Tvmax_eb[*,aa] = EB_veg_mo( epsilon, alpha[aa], cg, zr, h, rc_max, ta, ua, rg, rha, SIGMA)
endfor
...
for aa=0,n_elements(h)-1 do begin
  Tvmin_eb[*,aa] = EB_veg_mo( epsilon, alpha, cg, zr, h[aa], rc_min, ta, ua, rg, rha, SIGMA)
  Tvmax_eb[*,aa] = EB_veg_mo( epsilon, alpha, cg, zr, h[aa], rc_max, ta, ua, rg, rha, SIGMA)
endfor
...
for aa=0,n_elements(alpha)-1 do begin
  Tvmin_eb[*,aa] = EB_veg_mo( epsilon, alpha[aa], cg, zr, h, rc_min, ta, ua, rg, rha, SIGMA)
  Tvmax_eb[*,aa] = EB_veg_mo( epsilon, alpha[aa], cg, zr, h, rc_max, ta, ua, rg, rha, SIGMA)
  Tsmin_eb[*,aa] = EB_soil_mo( 0.957, alpha[aa], 0.32, zr, 0.001, rss_min, ta, ua, rg, rha, SIGMA)
  Tsmax_eb[*,aa] = EB_soil_mo( 0.957, alpha[aa], 0.32, zr, 0.001, rss_max, ta, ua, rg, rha, SIGMA)
endfor
